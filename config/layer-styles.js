...
oplande: {
        ...
        attributeTitleField: "attributter",
            attributes: [
        { field: "PULS_Navn", label: "PULS navn" },
        { field: "Area_PULS", label: "Areal [Ha.]" },
        { field: "Red_area_P", label: "Reduceret Areal [Ha.]" },                      
        { field: "Bef_area_P", label: "Befæstet Areal [Ha.]" }, 
        { field: "Høj_Bolig_[Ha]", label: "Høje Boligområder [Ha.]" },        
        { field: "Ikke_bef_[Ha]", label: "Ikke Befæstet [Ha.]" },
        { field: "Industri_[Ha]", label: "Industri [Ha.]" },
        { field: "Kunstgræs_[Ha]", label: "Kunstgræs [Ha.]" },        
        { field: "Lav_bolig_[Ha]", label: "Lave Boligområder [Ha.]" },
        { field: "Losseplads_[Ha]", label: "Losseplads [Ha.]" },
        { field: "Parkering_[Ha]", label: "Parkering [Ha.]" },
